defmodule SampleWeb.UserAuthTest do
  use SampleWeb.ConnCase

  alias Phoenix.LiveView
  alias Sample.Accounts
  alias SampleWeb.UserAuth
  import Sample.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, SampleWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      SampleWeb.Endpoint.subscribe(live_socket_id)
